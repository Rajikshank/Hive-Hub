...
import { SalaryRangeSelector } from "../views/SalaryRangeSelector";
import JobDescriptionEditor from "../richTextEditor/JobDescriptionEditor";
import { UploadDropzone } from "../views/UploadThing";
import { BenefitsSelector } from "../views/BenefitsSelector";

import { JobListingDurationSelector } from "../views/JobListingDurationSelector";
import { createJob } from "@/actions/createJobPostAction";
import { toast } from "sonner";
...
export function CreateJobForm({
  ...
  async function onSubmit(values: z.infer<typeof jobSchema>) {
    try {
      setPending(true);
      console.log("submitting for ...", values);
